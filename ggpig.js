...
(function() {
    ...
    (function(c, x) {
        // 检查模块系统并导出 React
        "object" === typeof exports && "undefined" !== typeof module ? x(exports) : 
        "function" === typeof define && define.amd ? define(["exports"], x) : 
        (c = c || self, x(c.React = {}))
    })(this, function(c) {
        // 创建 React 元素的函数
        function x(a) {
        ...
        function w(a, b, e) {
            this.props = a; // 组件的 props
            this.context = b; // 组件的 context
            this.refs = W; // 引用
            this.updater = e || X; // 更新器
        }
        ...
        function B(a, b, e, m, d) {
            ...
            if (h) return h = a, d = d(h), a = "" === m ? "." + N(h, 0) : m, 
                ca(d) ? (e = "", null != a && (e = a.replace(da, "$&/") + "/"), 
                B(d, b, e, "", function(a) { return a })) : null != d && (M(d) && (d = na(d, e + (!d.key || h && h.key === d.key ? "" : ("" + d.key).replace(da, "$&/") + "/") + a)), 
                b.push(d)), 1;
            h = 0;
            m = "" === m ? "." : m + ":";
            if (ca(a))
                for (var l = 0; l < a.length; l++) {
                    ...
                    for (a = f.call(a), l = 0; !(c = a.next()).done;) c = c.value, 
                        f = m + N(c, l++), h += B(c, b, e, f, d);
                else if ("object" === c) throw b = String(a), 
        ...
        var y = Symbol.for("react.element"), // React 元素的标识符
            pa = Symbol.for("react.portal"), // React portal 的标识符
            ra = Symbol.for("react.fragment"), // React fragment 的标识符
            sa = Symbol.for("react.strict_mode"), // React 严格模式的标识符
            ta = Symbol.for("react.profiler"), // React 性能分析的标识符
            ua = Symbol.for("react.provider"), // React 提供者的标识符
            va = Symbol.for("react.context"), // React 上下文的标识符
            wa = Symbol.for("react.forward_ref"), // React 转发引用的标识符
            xa = Symbol.for("react.suspense"), // React 懒加载的标识符
            ya = Symbol.for("react.memo"), // React 记忆组件的标识符
            za = Symbol.for("react.lazy"), // React 懒加载的标识符
            V = Symbol.iterator, // 迭代器的标识符
            X = {
        ...
        var ca = Array.isArray, // 检查是否为数组
            aa = Object.prototype.hasOwnProperty, // 检查对象属性
            L = {
                current: null // 当前拥有者
            },
            ba = {
        ...
        var q = [], // 任务队列
            ...
            u = !1, // 是否有任务
            z = !1, // 是否需要更新
            ja = "function" === typeof setTimeout ? setTimeout : null, // 定时器
            ea = "function" === typeof clearTimeout ? clearTimeout : null, // 清除定时器
            ma = "undefined" !== typeof setImmediate ? setImmediate : null; // 立即执行
        ...
        // 导出组件和功能
        c.Component = w; // 导出 Component 类
        c.Fragment = ra; // 导出 Fragment
        c.Profiler = ta; // 导出 Profiler
        c.PureComponent = K; // 导出 PureComponent
        c.StrictMode = sa; // 导出 StrictMode
        c.Suspense = xa; // 导出 Suspense
        c.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = t; // 内部 API
